        ...
        <div class="my-3 block p-6 rounded-lg shadow-lg bg-white w-full">
            <form method="post" action="{{ route('artisan.completProfile.update') }}" class="" enctype="multipart/form-data"> @csrf @method('PUT')
              ...
              <div class="form-group mb-6">
                ...
                <input type="date" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none @error('date_naissance') border-2 border-rose-600 @enderror " id="date_naissance" name="date_naissance" value="{{ old('date_naissance') == '' ? auth()->user()->completedProfile->date_naissance : old('date_naissance')}}">
              ...
              <div class="form-group mb-6">
                ...
                <div class="flex @error('sexe') border-2 border-rose-600 @enderror">
                    <div class="">
                        <input type="radio" name="sexe" class="" id="homme" value="homme" {{ auth()->user()->completedProfile->sexe == 'homme' ? 'checked' : '' }}/>
                        <label for="homme" class="">homme</label>
                    </div>
                    <div class="mx-3">
                        <input type="radio" name="sexe" class="" id="femme" value="femme" {{ auth()->user()->completedProfile->sexe == 'femme' ? 'checked' : '' }}/>
              ...
              <div class="form-group mb-6">
                ...
                <input type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none @error('numero_piece_identite') border-2 border-rose-600 @enderror " id="numero_piece_identite" placeholder="numero de la piece d'identité" name="numero_piece_identite" value="{{ old('numero_piece_identite') == '' ? auth()->user()->completedProfile->numero_piece_identite : old('numero_piece_identite')}}">
              ...
              <div class="form-group mb-6">
                ...
                <input type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none @error('pays') border-2 border-rose-600 @enderror " id="pays" placeholder="cote d'ivoire" name="pays" value="{{ old('pays') == '' ? auth()->user()->completedProfile->pays : old('pays')}}">
                @error('pays')
                    <small  class="block mt-1 text-md text-red-500"> {{ $message }}</small>
                @enderror
              </div>
              <div class="form-group mb-6">
                ...
                <input type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none @error('ville') border-2 border-rose-600 @enderror " id="ville" placeholder="Abidjan" name="ville" value="{{ old('ville') == '' ? auth()->user()->completedProfile->ville : old('ville')}}">
                @error('ville')
                    <small  class="block mt-1 text-md text-red-500"> {{ $message }}</small>
                @enderror
              </div>
              ...
              <div class="form-group mb-6">
                ...
                <input type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none @error('rue') border-2 border-rose-600 @enderror " id="rue" placeholder="D4" name="rue" value="{{ old('rue') == '' ? auth()->user()->completedProfile->rue : old('rue')}}">
                @error('rue')
                    <small  class="block mt-1 text-md text-red-500"> {{ $message }}</small>
                @enderror
              </div>
              <div class="form-group mb-6">
                ...
                <select class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none @error('job') border-2 border-rose-600 @enderror " id="job" name="job_id">
                    ...
                    @foreach($jobs as $job)
                        <option value="{{$job->id}}" {{ auth()->user()->completedProfile->job_id == $job->id ? 'selected' : '' }}>{{$job->labelle}}</option>
                    @endforeach
                </select>
                @error('job')
                    <small  class="block mt-1 text-md text-red-500"> {{ $message }}</small>
              ...
              <div class="form-group mb-6">
                ...
                <textarea rows=5 type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none @error('description') border-2 border-rose-600 @enderror " id="description" placeholder="detail de vos service" name="description" >{{ old('description') == '' ? auth()->user()->completedProfile->description : old('description')}}</textarea>
                @error('description')
                    <small  class="block mt-1 text-md text-red-500"> {{ $message }}</small>
                @enderror
              </div>
